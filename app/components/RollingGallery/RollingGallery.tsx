...
import img9 from "@/app/images/img9.jpg";
import img10 from "@/app/images/img10.jpg";
import img11 from "@/app/images/img11.jpg";
import img12 from "@/app/images/img12.jpg";
import img13 from "@/app/images/img13.jpg";
          ...
          {galleryImages.map((url, i) => (
            ...
            >
              <img
                src={url}
                alt="gallery"
                className="pointer-events-none h-[500px] w-[500px] rounded-[15px] border-[3px] border-white object-cover transition-transform duration-300 ease-out group-hover:scale-105 sm:h-[150px] sm:w-[150px]"
              />
            </div>
          ))}
        </motion.div>
